...
interface AsyncSelectBase<TData, TValue extends string>
  extends SelectTriggerAppearance {
  fetchOptions: SelectOptionsFetcher<TData>;
...
interface AsyncSelectSingleProps<TValue extends string> {
  multi?: false;
  clearable?: false;
  value?: TValue;
...
interface AsyncSelectSingleClearableProps<TValue extends string> {
  multi?: false;
  clearable: true;
  value?: TValue | null;
...
interface AsyncSelectMultiProps<TValue extends string> {
  multi: true;
  clearable?: boolean;
  value?: TValue[];
  onValueChange?: (value: TValue[]) => void;
...
export type AsyncSelectProps<TData, TValue extends string = string> =
  AsyncSelectBase<TData, TValue> &
    (
      | AsyncSelectSingleProps<TValue>
      | AsyncSelectSingleClearableProps<TValue>
      | AsyncSelectMultiProps<TValue>
    );

// ─── SearchSelectProps ─────────────────────────────────────────────────────────

interface SearchSelectBase<TData, TValue extends string>
  extends SelectTriggerAppearance {
  fetchOptions: SelectOptionsFetcher<TData>;
  getOption: (item: TData) => SelectOption<TValue>;
  fetchOnMount?: boolean;
...
interface SearchSelectSingleProps<TValue extends string> {
  multi?: false;
  clearable?: false;
  value?: TValue;
  onValueChange?: (value: TValue) => void;
...
interface SearchSelectSingleClearableProps<TValue extends string> {
  multi?: false;
  clearable: true;
  value?: TValue | null;
  onValueChange?: (value: TValue | null) => void;
...
interface SearchSelectMultiProps<TValue extends string> {
  multi: true;
  clearable?: boolean;
  value?: TValue[];
  onValueChange?: (value: TValue[]) => void;
...
export type SearchSelectProps<TData, TValue extends string = string> =
  SearchSelectBase<TData, TValue> &
    (
      | SearchSelectSingleProps<TValue>
      | SearchSelectSingleClearableProps<TValue>
      | SearchSelectMultiProps<TValue>
    );
